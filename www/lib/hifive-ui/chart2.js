...
(function($) {
	 ...
	 */
	function IncomeDataSourceManager() {
		this._count = 0;
		this._map = {};
	...
	IncomeDataSourceManager.prototype = {
		/**
		 * コンテキストを自分自身にした関数を取得します
		 * 
		 * @param {Function} func 関数
	...
	h5.u.obj.expose('h5.ui.components.chart', {
		incomeDataSourceManager: new IncomeDataSourceManager(),
		createIncomeDataSourceManager: function() {
			return new IncomeDataSourceManager();
		}
	});
})(jQuery);
...
//				}
	...
	var dataSourceManager = h5.ui.components.chart.incomeDataSourceManager;
	...
	var chartController = {
		...
		__name: 'h5.ui.components.chart.IncomeChartController',
